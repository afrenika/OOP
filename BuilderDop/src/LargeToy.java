public class LargeToy extends Toy{

    public LargeToy(String color, Material material, Wadding filling,  Integer limbsCount, boolean audioSpeaker, AnimalEarsType animalEars, boolean scallop, boolean tail, boolean fangs, String hairColor) {
    ...
    public void printDescription(){
        System.out.println("Информация о игрушке(большая версия)");
        System.out.println("Цвет - " + color);
        System.out.println("Материал - " + material);
        System.out.println("Кол-во ног - " + limbsCount);
    ...
    @Override
    public void stand(){
        System.out.println("Поставить в большую стойку");
    }
