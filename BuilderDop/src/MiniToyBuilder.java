public class MiniToyBuilder implements Builder{
    ...
    public MiniToy getResult() {
        return new MiniToy(color, material, filling, limbsCount, audioSpeaker, animalEars, scallop, tail, fangs, hairColor);
    }
