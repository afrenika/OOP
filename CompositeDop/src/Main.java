...
public class Main {
    ...
    public static void main(String[] args) {
        SchoolComponent school1 = new School("Школа №1");
        SchoolComponent school2 = new School("Школа №2");
        SchoolComponent school3 = new School("Школа №3");

        SchoolComponent school = new School("Объединенная школа");
        ...
        SchoolComponent school4 = new School("Школа №4");
